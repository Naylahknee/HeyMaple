...
export default function Messages() {
  ...
  const selectedUser = MOCK_USERS[0]; // Sarah Chen for demo
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-80 border-r bg-white dark:bg-slate-900 flex flex-col hidden md:flex">
          <div className="p-4 border-b">
            <h2 className="font-heading font-bold text-xl mb-4">Messages</h2>
        ...
        <div className="flex-1 flex flex-col bg-white dark:bg-slate-900">
          ...
          <div className="border-t p-4 space-y-3">
            ...
            <p className="text-xs text-muted-foreground">💡 Tip: Be specific about project needs and timeline when collaborating</p>
          </div>
        </div>
      </div>
    </div>
